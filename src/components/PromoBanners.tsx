  ...
  return (
    <div className="container mx-auto px-4 md:px-8 py-6">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* Banner 1 */}
        <div className="bg-[#EAF6E3] rounded-xl p-6 relative overflow-hidden h-48 flex items-center group cursor-pointer">
        ...
        {/* Banner 2 */}
        <div className="bg-[#E1F0FF] rounded-xl p-6 relative overflow-hidden h-48 flex items-center group cursor-pointer">
          <div className="z-10 w-2/3">
            <h3 className="text-xl font-bold text-[#1E3A8A] mb-1">Frozen Fish</h3>
            <p className="text-xs text-[#3B82F6] mb-4">Premium Quality</p>
            <button className="text-[#1E3A8A] font-bold text-sm flex items-center gap-1 group-hover:gap-2 transition-all">
              Shop Now <ArrowRight size={16} />
            </button>
          </div>
        ...
        {/* Banner 3 */}
        <div className="bg-[#FFF4E6] rounded-xl p-6 relative overflow-hidden h-48 flex items-center group cursor-pointer">
          <div className="z-10 w-2/3">
            ...
            <button className="text-[#9A3412] font-bold text-sm flex items-center gap-1 group-hover:gap-2 transition-all">
              Shop Now <ArrowRight size={16} />
            </button>
          </div>
